...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-json-server/node_modules/json-server/lib/server/</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-json-server/node_modules/json-server/lib/server/</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; node-npmtest-json-server/node_modules/json-server/lib/server/</div>
</div>
<div class="body">
